module RTC_DS3231(input clk,rst,RW_start,
                  inout sda,
                  output scl,
                  output data_out,
                  output reg [3:0] LED );
...
Main_I2C uut (clk,rst,i2c_start,ReadWrite,rtc_data,sda, data_valid, state , scl,rx_data, uart_done, rx_hrs, rx_min, rx_sec, data_out);
ila_0   uu2t (clk,tx_valid,state,rtc_counter,rx_hrs ,global_counter , input_data1 );
